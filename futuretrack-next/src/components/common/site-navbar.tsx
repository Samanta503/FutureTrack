  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#070820]/80 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <button className="rounded-full bg-gradient-to-r from-[#5864ff] to-[#62dcff] px-4 py-2 text-sm font-semibold text-[#090b26] shadow-[0_8px_24px_rgba(98,220,255,0.25)] transition hover:scale-[1.02]">
          Get Started
        </button>
      </div>
    </header>
